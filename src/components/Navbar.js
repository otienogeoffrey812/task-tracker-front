  ...
  var NOTIFICATIONS_DATA = [
        {
            ...
            "read": false,
            "image": Profile3,
            "sender": "Geoffrey Otieno",
            "time": "a few moments ago",
            "link": "#",
            "message": `Geoffrey has assigned you a new task.`
        },
        {
            "id": 2,
            "read": false,
              ...
              <Dropdown.Toggle as={Nav.Link} className="pt-1 px-0">
                <div className="media d-flex align-items-center">
                  ...
                  <div className="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                    <span className="mb-0 font-small fw-bold">{user != undefined ? user.firstName +" "+ user.secondName : ""}</span>
                  </div>
                </div>
              </Dropdown.Toggle>
